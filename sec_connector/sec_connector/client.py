"""SEC EDGAR client for fetching and filtering filings."""
...
class SECClient:
    ...
    def lookup_company(self, ticker: str) -> Company:
        ...
        Returns:
            Company model with ticker, CIK, and name
            
        Raises:
            ValueError: If ticker not found or invalid
        """
    ...
    def list_filings(self, cik: str, filters: FilingFilter) -> list[Filing]:
        ...
        Args:
            ...
            filters: FilingFilter with optional form_types, date range, and limit
            
        Returns:
            List of Filing objects, sorted by date descending
            
        Raises:
            ValueError: If CIK not found or invalid
        """
